...
/*   Updated: 2024/05/23 21:20:38 by alae             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

int	new_line(t_lis *stash)
{
	int		i;
	t_lis	*last;
...
void	read_stash(int fd, t_lis **stash, int *readed)
{
	char	*buffer;
...
void	create_line(t_lis *stash, char **line)
{
	int	i;
	int	len;
...
void	extract_line(t_lis *stash, char **line)
{
	int	i;
	int	j;
